class ZCL_ZMATERIAL_DATA_MPC definition
  public
...
CLASS ZCL_ZMATERIAL_DATA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMATERIAL_DATA_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZMATERIAL_DATA_MPC=>TS_MATERIAL' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251217170343'.                  "#EC NOTEXT
