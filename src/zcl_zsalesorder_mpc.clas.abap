class ZCL_ZSALESORDER_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_SALESHEADER,
     ORDERID type string,
     ORDERTYP type string,
     SALESORG type string,
  end of TS_SALESHEADER .
  types:
TT_SALESHEADER type standard table of TS_SALESHEADER .
  types:
  ...
  types:
TT_SALESITEM type standard table of TS_SALESITEM .

  constants GC_SALESHEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesHeader' ##NO_TEXT.
  constants GC_SALESITEM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesItem' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSALESORDER_MPC===========CP' ##NO_TEXT.

  methods DEFINE_SALESHEADER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SALESITEM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZSALESORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSALESORDER_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'zsalesorderassoc' "#EC NOTEXT
                            iv_left_type        = 'SalesHeader' "#EC NOTEXT
                            iv_right_type       = 'SalesItem' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - zsalesorderassoc
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'OrderID'   iv_dependent_property = 'OrderID' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'zsalesorderassocSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SalesHeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SalesItemSet'             "#EC NOTEXT
                                              iv_association_name      = 'zsalesorderassoc' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - SalesHeader
lo_entity_type = model->get_entity_type( iv_entity_name = 'SalesHeader' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'SalesItemSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SALESITEMSET' "#EC NOTEXT
                                                              iv_association_name = 'zsalesorderassoc' ). "#EC NOTEXT
  endmethod.


  method DEFINE_SALESHEADER.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SalesHeader' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'OrderTyp' iv_abap_fieldname = 'ORDERTYP' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESORDER_MPC=>TS_SALESHEADER' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesHeaderSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SalesItem' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESORDER_MPC=>TS_SALESITEM' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesItemSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260208050350'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'SalesHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '001'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'OrderTyp'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesOrg'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'OrderID'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesItem'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
