class ZCL_ZGW100_01_CDS_MPC definition
  public
...
public section.
  ...
  types:
     TS_SUPPLIER type GW100CSUPPLIER .
  types:
...
CLASS ZCL_ZGW100_01_CDS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW100_01_CDS_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Article' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Productuuid' iv_abap_fieldname = 'PRODUCTUUID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Productcategory' iv_abap_fieldname = 'PRODUCTCATEGORY' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Dimensionunit' iv_abap_fieldname = 'DIMENSIONUNIT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Productpictureurl' iv_abap_fieldname = 'PRODUCTPICTUREURL' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Productvalueaddedtax' iv_abap_fieldname = 'PRODUCTVALUEADDEDTAX' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Supplieruuid' iv_abap_fieldname = 'SUPPLIERUUID' ). "#EC NOTEXT
lo_property->set_type_edm_guid( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Productbaseunit' iv_abap_fieldname = 'PRODUCTBASEUNIT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'CUNIT' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'GW100CARTICLE'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ArticleSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Supplier_Articles' "#EC NOTEXT
                            iv_left_type        = 'Supplier' "#EC NOTEXT
                            iv_right_type       = 'Article' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Supplier_Articles
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Businesspartneruuid'   iv_dependent_property = 'Supplieruuid' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Supplier_ArticlesSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SupplierSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ArticleSet'             "#EC NOTEXT
                                              iv_association_name      = 'Supplier_Articles' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'Article' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ARTICLE' "#EC NOTEXT
                                                              iv_association_name = 'Supplier_Articles' ). "#EC NOTEXT
* Navigation Properties for entity - Article
lo_entity_type = model->get_entity_type( iv_entity_name = 'Article' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'GW100CSUPPLIER'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260331183527'.                  "#EC NOTEXT
