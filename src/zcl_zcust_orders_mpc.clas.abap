class ZCL_ZCUST_ORDERS_MPC definition
  public
...
CLASS ZCL_ZCUST_ORDERS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCUST_ORDERS_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'zcust_orders' "#EC NOTEXT
                            iv_left_type        = 'Customer' "#EC NOTEXT
                            iv_right_type       = 'Order' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - zcust_orders
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'CustId'   iv_dependent_property = 'Customer' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'zcust_ordersSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'CustomerSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'OrderSet'             "#EC NOTEXT
                                              iv_association_name      = 'zcust_orders' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrderSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ORDERSET' "#EC NOTEXT
                                                              iv_association_name = 'zcust_orders' ). "#EC NOTEXT
  endmethod.
...
lo_property = lo_entity_type->create_property( iv_property_name = 'CustId' iv_abap_fieldname = 'CUSTID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZCUST_ORDERS_MPC=>TS_CUSTOMER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZCUST_ORDERS_MPC=>TS_ORDER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260126074953'.                  "#EC NOTEXT
