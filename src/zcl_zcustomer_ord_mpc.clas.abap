class ZCL_ZCUSTOMER_ORD_MPC definition
  public
...
CLASS ZCL_ZCUSTOMER_ORD_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCUSTOMER_ORD_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Zassoc_Cust' "#EC NOTEXT
                            iv_left_type        = 'Customer' "#EC NOTEXT
                            iv_right_type       = 'Orders' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Zassoc_Cust
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'CustID'   iv_dependent_property = 'CustID' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ZASSOC_CustSet'                         "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrdersSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ORDERSSET' "#EC NOTEXT
                                                              iv_association_name = 'Zassoc_Cust' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZCUSTOMER_ORD_MPC=>TS_CUSTOMER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZCUSTOMER_ORD_MPC=>TS_ORDERS' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251225105931'.                  "#EC NOTEXT
