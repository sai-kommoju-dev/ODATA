class ZCL_ZCUST_ORDERS_DPC definition
  public
...
protected section.
  ...
  methods CUSTOMERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZCUST_ORDERS_MPC=>TS_CUSTOMER
    raising
  ...
  methods CUSTOMERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZCUST_ORDERS_MPC=>TT_CUSTOMER
  ...
  methods ORDERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZCUST_ORDERS_MPC=>TS_ORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZCUST_ORDERS_MPC=>TT_ORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZCUST_ORDERS_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 26.01.2026 07:49:56 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZCUST_ORDERS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA customerset_create_entity TYPE zcl_zcust_orders_mpc=>ts_customer.
 DATA orderset_create_entity TYPE zcl_zcust_orders_mpc=>ts_order.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA customerset_get_entity TYPE zcl_zcust_orders_mpc=>ts_customer.
 DATA orderset_get_entity TYPE zcl_zcust_orders_mpc=>ts_order.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZCUST_ORDERS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA customerset_get_entityset TYPE zcl_zcust_orders_mpc=>tt_customer.
 DATA orderset_get_entityset TYPE zcl_zcust_orders_mpc=>tt_order.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA customerset_update_entity TYPE zcl_zcust_orders_mpc=>ts_customer.
 DATA orderset_update_entity TYPE zcl_zcust_orders_mpc=>ts_order.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
